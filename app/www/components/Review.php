...
function Review(string $reviewId, string $userId, string $username, int $rating, string $body, DateTime $date, bool $isDeletable) {
?>
<article data-reviewId="<?= $reviewId ?>" class="review p-3">
    <div class="d-flex justify-content-between">
        <div class="d-flex gap-4 align-items-center"> 
        <a href="/profile/?userId=<?= $userId ?>"><?= $username ?></a>
        </div>
