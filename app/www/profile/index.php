            ...
            <div class="row align-items-center justify-content-center p-5">
                ...
                <div class="col-12 col-md-8 text-center text-md-start">
                    <h1 class="mb-1 d-flex justify-content-md-start gap-2 justify-content-center align-text-center">
                        ...
                        if ($user->isAdmin) {
                        ?>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="CurrentColor" width="30px" height="30px" viewBox="0 0 1920 1920">
                    ...
                    <!-- Admin -->
                        <button id="change-admin" <?= $user->isAdmin ? "data-admin" : "" ?> class="mt-4 d-flex align-items-center justify-content-center justify-content-md-start gap-2 mx-auto mx-md-0 ps-0">
